...
import com.techun.pomodoro.data.receivers.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            val startIntet = Intent(context, TimerNotificationActionReceiver::class.java)
            startIntet.action = AppConstants.ACTION_START
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .addAction(R.drawable.outline_play_arrow_24, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            nBuilder.setContentTitle("Timer is Running")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.outline_stop_24, "Stop", stopPendingIntent)
        ...
        fun showTimerPaused(context: Context) {
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.outline_play_arrow_24, "Resume", resumePendingIntent)
